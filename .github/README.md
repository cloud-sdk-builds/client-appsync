...
[`@aws-sdk/client-appsync`](https://www.npmjs.com/package/@aws-sdk/client-appsync/v/3.484.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-appsync@3.484.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-BcBjS172WbYckez2a4taXLBy9g3fYp2Cq9rWPCmlAHOkWnvO23+hYkDaT4LJ2so9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-appsync": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-appsync@3.484.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-appsync@3.484.0/index.min.mjs": "sha384-BcBjS172WbYckez2a4taXLBy9g3fYp2Cq9rWPCmlAHOkWnvO23+hYkDaT4LJ2so9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-appsync/blob/refs/tags/3.484.0/LICENSE
```
